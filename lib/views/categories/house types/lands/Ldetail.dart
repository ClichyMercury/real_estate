...
class Ldetail extends StatelessWidget {
  final LandsProperty lProperty;

  Ldetail({Key? key, required this.lProperty}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Hero(
            tag: lProperty.frontImage,
            child: Container(
              height: size.height * 0.5,
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(lProperty.frontImage),
                  fit: BoxFit.cover,
                ),
              ),
              child: Container(
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage(lProperty.ownerImage),
                                    fit: BoxFit.cover,
                                  ),
                                  shape: BoxShape.circle,
                                ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: buildPhotos(lProperty.images),
                        ),
                      ),
                    ),
                  ],
