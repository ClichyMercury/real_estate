...
class _LandsState extends State<Lands> {
  List<LandsProperty> properties = getLandsPropertyList();
  ...
  Widget buildProperty(LandsProperty property, int index) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Ldetail(lProperty: property)),
        );
      },
      child: Card(
