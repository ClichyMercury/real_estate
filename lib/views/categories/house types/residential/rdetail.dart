...
class rdetail extends StatelessWidget {
  final ResidentialHomesProperty rProperty;

  rdetail({Key? key, required this.rProperty}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Hero(
            tag: rProperty.frontImage,
            child: Container(
              height: size.height * 0.5,
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(rProperty.frontImage),
                  fit: BoxFit.cover,
                ),
              ),
              child: Container(
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage(rProperty.ownerImage),
                                    fit: BoxFit.cover,
                                  ),
                                  shape: BoxShape.circle,
                                ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: buildPhotos(rProperty.images),
                        ),
                      ),
                    ),
                  ],
