...
class Adetail extends StatelessWidget {
  final ApartementsProperty aProperty;

  Adetail({Key? key, required this.aProperty}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: [
          Hero(
            tag: aProperty.frontImage,
            child: Container(
              height: size.height * 0.5,
              decoration: BoxDecoration(
                image: DecorationImage(
                  image: AssetImage(aProperty.frontImage),
                  fit: BoxFit.cover,
                ),
              ),
              child: Container(
                          ...
                          Row(
                            children: [
                              Container(
                                ...
                                decoration: BoxDecoration(
                                  image: DecorationImage(
                                    image: AssetImage(aProperty.ownerImage),
                                    fit: BoxFit.cover,
                                  ),
                                  shape: BoxShape.circle,
                                ),
                    ...
                    Expanded(
                      child: Padding(
                        ...
                        child: ListView(
                          ...
                          shrinkWrap: true,
                          children: buildPhotos(aProperty.images),
                        ),
                      ),
                    ),
                  ],
