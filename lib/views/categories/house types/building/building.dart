...
class _BuildingState extends State<Building> {
  List<BuildingProperty> properties = getBuildingPropertyList();
  ...
  Widget buildProperty(BuildingProperty property, int index) {
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => bdetail(bProperty: property)),
        );
      },
      child: Card(
