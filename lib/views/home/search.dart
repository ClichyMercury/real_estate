  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          Padding(
            padding: EdgeInsets.only(top: 20, left: 24, right: 24, bottom: 16),
            child: TextField(
              controller: search,
              style: TextStyle(
                fontSize: 28,
              ...
              decoration: InputDecoration(
                ...
                suffixIcon: Padding(
                  ...
                  child: IconButton(
                    onPressed: () {
                      print(search.text);
                      print(getPropertyList().first.name);
                      print("xxxxxxxxxxxxxxxxxxxxxxx");
                      final index0 = getPropertyList().indexWhere((element) =>
                          element.name.toLowerCase() ==
                          search.text.toLowerCase());
                      if (index0 != -1 &&
                          search.text.contains(properties.first.name)) {
                        print("index $index0 : ${properties.first.name}");
                      }
                    },
